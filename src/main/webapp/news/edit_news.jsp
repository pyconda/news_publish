...
<form action="${pageContext.request.contextPath}/editNews.action" name="ff"
	...
	<br>
	新闻内容标题：<br>
	<input id="contentTitle" name="contentTitle" value="${news.contentTitle }" type="text"/><br>
	内容摘要:<br>
	<textarea id="contentAbstract" name="contentAbstract" cols="100" rows="2"
		style="width:800px;height:50px;">${news.contentAbstract }</textarea><br>
	内容：<br>
